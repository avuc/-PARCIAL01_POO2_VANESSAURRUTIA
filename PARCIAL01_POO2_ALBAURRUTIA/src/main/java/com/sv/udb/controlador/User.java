...
@NamedQueries({
    ...
    @NamedQuery(name = "User.findByDefaultRole", query = "SELECT u FROM User u WHERE u.defaultRole = :defaultRole"),
...
public class User implements Serializable {
    ...
    public String toString() {
        return "com.sv.udb.controlador.User[ userPK=" + userPK + " ]";
    }
